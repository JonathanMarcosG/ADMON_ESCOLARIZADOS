...
function busqueda(tipo) {
    ...
    document.getElementById("caja_busqueda_pref").placeholder = "";
    document.getElementById("caja_busqueda_pref").style.border = "gray 1px solid";
}
...
function search() {
    if ($("#caja_busqueda_pref").val() === "" || $("#caja_busqueda_pref").val() === null) {
        ...
        var usuario = $("#usuarioOculto").val();
        var contra = $("#contraOculta").val();
        var parametroInicial = $("#caja_busqueda_pref").val().trim();
        var bandera;
...
//                        $("#margenVerNotif").load("Paginas/Consultas/Notificaciones.jsp #margenVerNotif");
                        ...
                        $("#errorNotif").text(" ");
                        $("#errorNotif").css("display", "block");
                        $("#errorNotif").append(data.fontsize(3).fontcolor("red"));
...
function notifPago() {
    ...
    var nombre = $("#caja_nomN").val() + " " + $("#caja_apN").val() + " " + $("#caja_amN").val();
...
//    var folio = $("#caja_fichaN").val();
    ...
    jQuery.get("servletReenvioPref", {correo: correo, curp: curp},
            function (data) {
